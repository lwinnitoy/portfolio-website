...
public class A1Tester {
	...
	public static void testGreatestCommonDenominator() {
		...
		System.out.println("Testing greatestCommonDenominator(36, 54)");
		result = A1Exercises.greatestCommonDenominator(36, 54);
		expected = 18;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(11, 7)");
		result = A1Exercises.greatestCommonDenominator(11, 7);
		expected = 1;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(375, 15)");
		result = A1Exercises.greatestCommonDenominator(375, 15);
		expected = 15;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(15, 375)");
		result = A1Exercises.greatestCommonDenominator(15, 375);
		expected = 15;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	...
	public static void testCountMatches() {
		...
		System.out.println("Testing countMatches(arr3, 6)");
		result = A1Exercises.countMatches(arr1, 6);
		expected = 0;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		...
		System.out.println("Testing countMatches(arr4, 1)");
		result = A1Exercises.countMatches(arr4,1);
		expected = 4;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing countMatches(arr5, -1)");
		result = A1Exercises.countMatches(arr5, -1);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
