...
public class A2Tester {
	...
	public static void testMoneyRaised() {
		...
		result = f3.moneyRaised();
		expected = 259;
		displayResults(result==expected, "money raised in fundraiser with 3 items");

		result = f4.moneyRaised();
		expected = 255;
		displayResults(result==expected, "money raised in fundraiser with 2 items");
	}
	...
	public static void testMoneySpent() {
		...
		bidderName = new String("Ali");
		result = f3.moneySpent(bidderName);
		expected = 255;
		displayResults(result==expected, "amount "+bidderName+" spent at f3");

		bidderName = new String("Lee");
		result = f5.moneySpent(bidderName);
		expected = 80;
		displayResults(result==expected, "amount "+bidderName+" spent at f5");
		
		bidderName = new String("Sam");
		result = f6.moneySpent(bidderName);
		expected = 64;
		displayResults(result==expected, "amount "+bidderName+" spent at f6");
		
		bidderName = new String("Noah");
		result = f6.moneySpent(bidderName);
		expected = 180;
		displayResults(result==expected, "amount "+bidderName+" spent at f6");
	...
	public static void testMostExpensive() {
		...
		AuctionItem[] arr4 = {a3, a4, a5,a6, a7};

		Fundraiser f1 = new Fundraiser("Family Fundraiser", arr1);
		Fundraiser f2 = new Fundraiser("Fall Fundraiser", arr2);
		Fundraiser f3 = new Fundraiser("Team Fundraiser", arr3);
		Fundraiser f4 = new Fundraiser("Summer Fundraiser", arr4);
	...
	public static void testMostExpensiveItems() {
		...
		Fundraiser f2 = new Fundraiser("Fall Fundraiser", arr2);
		Fundraiser f3 = new Fundraiser("Team Fundraiser", arr3);
		Fundraiser f4 = new Fundraiser("Summer Fundraise", arr0);

		Fundraiser[] fundraisers0 = {};
		Fundraiser[] fundraisers1 = {f1, f2};
		Fundraiser[] fundraisers2 = {f3, f2, f1};
		Fundraiser[] fundraisers3 = {f4};
